...
int main(int argc, char *argv[]) {
    ...
    while(i !=7u){
        ...
        if(i == 1u){
            ...
            abb_elem new_elem;
            printf("Escribe el elemento que quieres agregar en el arbol, si pertenece al arbol no se agregara\n");
            scanf("%d",&new_elem);
            abb_add(tree,new_elem);
            abb_dump(tree);
        } else if(i == 3u){
            abb_elem kill_elem;
            printf("Escribe el elemento que quieres remover del arbol, si no pertenece no se eliminara nada\n");
            scanf("%d",&kill_elem);  
